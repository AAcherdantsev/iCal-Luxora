...
public partial class Icon : ContentView
{
    public new static readonly BindableProperty BackgroundColorProperty = BindableProperty.Create(
        nameof(BackgroundColor), typeof(Color), typeof(Icon),
        (Color)Microsoft.Maui.Controls.Application.Current.Resources["Primary"]);

    public static readonly BindableProperty IconColorProperty = BindableProperty.Create(
        nameof(IconColor), typeof(Color), typeof(Icon),
        (Color)Microsoft.Maui.Controls.Application.Current.Resources["SecondaryDark"]);

    public static readonly BindableProperty StrokeColorProperty = BindableProperty.Create(
        nameof(StrokeColor), typeof(Color), typeof(Icon),
